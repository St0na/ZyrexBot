...
exports.run = (client, message, args) => {
  ...
  message.channel
    .send(`Channel ${channel} has been locked.`)
  ...
  channel.send(
    new Discord.MessageEmbed()
      ...
      .setDescription(
        `Unfortunately, mods had to lock this channel${reasonn} Please respect this decision and it MAY be reopened in the future.`
      )
  );
};
exports.conf = {
